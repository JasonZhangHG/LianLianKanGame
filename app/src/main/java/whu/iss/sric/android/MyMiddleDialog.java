...
public class MyMiddleDialog extends Dialog implements OnClickListener {

    private MiddleGameView gameview;
    private Context context;

    public MyMiddleDialog(Context context, MiddleGameView gameview, String msg, int time) {
