...
import whu.iss.sric.view.EasyGameView;
...
public class PlayEastGameActivity extends Activity
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    gameOver();
                    dialog = new MyEasyDialog(PlayEastGameActivity.this, gameView, "Success", gameView.getTotalTime() - progress.getProgress());
                    dialog.show();
                    break;
                case 1:
                    gameOver();
                    dialog = new MyEasyDialog(PlayEastGameActivity.this, gameView, "Failed", gameView.getTotalTime() - progress.getProgress());
                    dialog.show();
                    break;
                default:
                    break;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gameView = (EasyGameView) findViewById(R.id.game_view);
