...
import whu.iss.sric.view.MiddleGameView;
...
public class PlayMiddleGameActivity extends Activity
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    gameOver();
                    dialog = new MyMiddleDialog(PlayMiddleGameActivity.this, gameView, "Success", gameView.getTotalTime() - progress.getProgress());
                    dialog.show();
                    break;
                case 1:
                    gameOver();
                    dialog = new MyMiddleDialog(PlayMiddleGameActivity.this, gameView, "Failed", gameView.getTotalTime() - progress.getProgress());
                    dialog.show();
                    break;
                default:
                    break;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gameView = (MiddleGameView) findViewById(R.id.game_view);
