    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    gameOver();
                    dialog = new MyDialog(PlayGameActivity.this, gameView, "Success", gameView.getTotalTime() - progress.getProgress());
                    dialog.show();
                    break;
                case 1:
                    gameOver();
                    dialog = new MyDialog(PlayGameActivity.this, gameView, "Failed", gameView.getTotalTime() - progress.getProgress());
                    dialog.show();
                    break;
                default:
                    break;
