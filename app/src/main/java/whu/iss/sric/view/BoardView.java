...
public class BoardView extends View {
    ...
    public void setTtype(int type) {
        if (type == 1) {
            ...
            loadBitmaps(5, r.getDrawable(R.drawable.fruit_05));
            loadBitmaps(6, r.getDrawable(R.drawable.fruit_06));
            loadBitmaps(7, r.getDrawable(R.drawable.fruit_01));
            loadBitmaps(8, r.getDrawable(R.drawable.fruit_02));
            loadBitmaps(9, r.getDrawable(R.drawable.fruit_03));
            loadBitmaps(10, r.getDrawable(R.drawable.fruit_04));
            loadBitmaps(11, r.getDrawable(R.drawable.fruit_05));
            loadBitmaps(12, r.getDrawable(R.drawable.fruit_06));
            loadBitmaps(13, r.getDrawable(R.drawable.fruit_01));
            loadBitmaps(14, r.getDrawable(R.drawable.fruit_02));
            loadBitmaps(15, r.getDrawable(R.drawable.fruit_03));
            loadBitmaps(16, r.getDrawable(R.drawable.fruit_04));
            loadBitmaps(17, r.getDrawable(R.drawable.fruit_05));
            loadBitmaps(18, r.getDrawable(R.drawable.fruit_06));
