...
import whu.iss.sric.utils.SoundPlay;


public class EasyGameView extends EasyBoardView {
    ...
    private static volatile int mScoreCount;
    ...
    public EasyGameView(Context context, AttributeSet atts) {
        super(context, atts);
    ...
    public void initGameCount() {
        mScoreCount = 0;
    }

    public int getGameStoreCount() {
        return mScoreCount;
    }
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == REFRESH_VIEW) {
                ...
                if (win()) {
                    ...
                    isStop = true; if (SharePreferenceUtil.getInstance().getBoolean("OpenMusic")) {
                } else if (die()) {
                    change();
                }
            }
